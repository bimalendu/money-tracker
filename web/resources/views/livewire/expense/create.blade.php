                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block mb-2 text-sm font-bold text-gray-700"><abbr title="Please enter the name of the item">{{ __('Name') }}</abbr></label>
                            <input type="text"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2"
                                class="block mb-2 text-sm font-bold text-gray-700"><abbr title="Please enter more information about the purchased item">{{ __('Description') }}</abbr></label>
                            <textarea
                                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput3"
                                class="block mb-2 text-sm font-bold text-gray-700"><abbr title="Please enter the price of the item">{{ __('Price') }}({{ currency_symbol()}})</abbr></label>
                            <input type="text"
                                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput4"
                                class="block mb-2 text-sm font-bold text-gray-700"><abbr title="Please mention a category for the item purchased">{{ __('Tags') }}</abbr></label>
                            <input type="text"
                                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput5"
                                class="block mb-2 text-sm font-bold text-gray-700">{{ __('Purchased on') }}</label>
                            <input type="date"
                                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
